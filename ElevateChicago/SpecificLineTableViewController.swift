...
//        let selectedStation = line?.stationIDs[indexPath.row]
        ...
        stationDetailViewController.station = Station(id: "40100", name: "Morse", hasElevator: false, red: true, blue: false, brown: false, green: false, orange: false, pink: false, purple: false, yellow: false)
    }
}
